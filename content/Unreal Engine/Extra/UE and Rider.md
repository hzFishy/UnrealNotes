...
You can edit them, for the templates defined by default by UE the template files are at `\YourEngineRootFolder\Engine\Content\Editor\Templates`.

See existing templates to makes yours.
